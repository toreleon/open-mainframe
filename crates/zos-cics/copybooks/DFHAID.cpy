      ...
      * Standard copybook for AID key values
      ******************************************************************
       01  DFHAID.
           02  DFHNULL   PIC X VALUE X'00'.
           02  DFHENTER  PIC X VALUE X'7D'.
           02  DFHCLEAR  PIC X VALUE X'6D'.
           02  DFHCLRP   PIC X VALUE X'6E'.
           02  DFHPEN    PIC X VALUE X'7E'.
           02  DFHOPID   PIC X VALUE X'E6'.
           02  DFHMSRE   PIC X VALUE X'61'.
           02  DFHSTRF   PIC X VALUE X'E8'.
           02  DFHTRIG   PIC X VALUE X'EF'.
